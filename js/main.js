  ...
  for (var i = 0; i < list_plants.length; i++) {
   ...
   thumbnailitem = '<img src="' + data_plan.imageUrl + '"/>'
      ...
      if (typeof data_plan.flower_colour !== 'undefined') {
        coloritem = ''
        for (var i = 0; i < data_plan.flowerColor.length; i++) {
          coloritem += '<img src="img/app_icons/colour_' + data_plan.flowerColor + '_on.png"/>'
        }
      ...
      if (typeof data_plan.flowerTime !== 'undefined') {
        ...
        for (var i = 0; i < data_plan.flowerTime.length; i++) {
          seasonitem += '<img src="img/app_icons/season_' + data_plan.flowerTime[i] + '_on.png"/>'
        }
